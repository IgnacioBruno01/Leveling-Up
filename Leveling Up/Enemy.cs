...
namespace Leveling_Up
{
    public abstract class Enemy : Character
    {
        ...
        public string botin;
        public Enemy(string path, Vector2f position, string type, string name, int level, int maxHP, int HP, int maxMana, int mana,
    ...
    {
        public Goblin(string path, Vector2f position, string type, string name, int level, int maxHP, int HP, int maxMana, int mana,
            int speed, int ataque, int ataquemagico, int defensa, int defensaMagica) : base(path, position, type, name, level, maxHP, HP, maxMana, mana,
             speed, ataque, ataquemagico, defensa, defensaMagica)
        {
            TextFileReader.ReadEnemyFromFile("Monstruos/Stage1/Goblin Stat.txt");
        }
    }
